...
@Autonomous (name = "RedScanShort", group = "Barcode")
        ...
        while (opModeIsActive()) {
            ...
            switch (pipeline.getAnalysis()) {
                case LEFT:
                    ...
                    encoderDrive(DRIVE_SPEED, arc90*2, -arc90*2,3);
                    encoderDrive(DRIVE_SPEED,9,9,2);
                    encoderDrive(DRIVE_SPEED,-arc90/2,arc90/2,2);
                    elbowmove(DRIVE_SPEED, -40,2);
                    sleep(2000);
                     leftpixelRelease();
                     elbowmove(DRIVE_SPEED,40,1.5);
                     encoderDrive(DRIVE_SPEED, arc90/2, -arc90/2,2);
                        sleep(2000);
                        encoderDrive(DRIVE_SPEED, 10,10,1.5);
                     encoderDrive(DRIVE_SPEED, arc90, -arc90,2.5);
                    encoderDrive(0.8,36,36,1.5);
